...
exports.main = async (event) => {
  ...
  const validapis = [
    ...
    'admin_newTodoteam',
    'admin_updateTodoteamEnabled',
    'admin_resetTodoteamAdminPassword',
    'admin_newSslLimitChange',
    'admin_getSslLimitChangeCount',
    'admin_getSslLimitChangeList',
    'admin_getSslPayOrderCount',
    'admin_getSslPayOrderList',
    ...
    'resource_checkResource',
    'resource_updateUserSetting',

  ...
  <div>
    ...
    <tiny-dialog-box class="dialog" :visible="webhookdialog" title="设置 Webhook 推送地址" @close="closeWebhookDialog">
      <div class="dialog-cz">
        ...
        <div>提示：</div>
        <div>1. 在输入的 Webhook 推送地址目录下新建一个名为 resource 的文件夹，在其中放置一个名为 xm2512webhooktoken.txt 、内容为 webhookToken
          的 TXT 文本文件。</div>
        <div>2. 点击“设置”按钮向服务器发送设置请求。</div>
        <div>3. 服务器收到设置请求后会向输入的 Webhook 推送地址/resource/xm2512webhooktoken.txt 发送 HTTP GET 请求，检查响应体是否是正确的
          webhookToken。</div>
